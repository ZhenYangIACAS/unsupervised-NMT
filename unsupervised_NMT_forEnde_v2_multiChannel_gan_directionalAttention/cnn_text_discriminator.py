...
class text_DisCNN(object):
  ...
  def __init__(self, sess, max_len, num_classes, vocab_size_s, vocab_size_t, batch_size,  dim_word, filter_sizes, num_filters, source_dict, target_dict, gpu_device, s_domain_data, t_domain_data, s_domain_generated_data, t_domain_generated_data, dev_s_domain_data=None, dev_t_domain_data=None, dev_s_domain_generated_data=None, dev_t_domain_generated_data=None, max_epoches=10, dispFreq = 1, saveFreq = 10, devFreq=1000, clip_c = 1.0, optimizer='adadelta', saveto='text_discriminator', reload=False, reshuffle = False, l2_reg_lambda=0.0, scope='text_discnn', init_device="/cpu:0", reuse_var=False):
        ...
        self.t_domain_data = t_domain_data
        self.s_domain_generated_data = s_domain_generated_data
        self.t_domain_generated_data = t_domain_generated_data
        self.dev_s_domain_data = dev_s_domain_data
        self.dev_t_domain_data = dev_t_domain_data
        self.dev_s_domain_generated_data = dev_s_domain_generated_data
        self.dev_t_domain_generated_data = dev_t_domain_generated_data
  ...
  def train(self, max_epoch = None, s_domain_data=None, t_domain_data=None, s_domain_generated_data=None, t_domain_generated_data=None):
  
      if s_domain_data is None or t_domain_data is None or s_domain_generated_data is None or t_domain_generated_data:
            s_domain_data = self.s_domain_data
            t_domain_data = self.t_domain_data
            s_domain_generated_data = self.s_domain_generated_data
            t_domain_generated_data = self.t_domain_generated_data
      
      print('the s_domain, t_domain, s_domain_generated_data, t_domain_generated_data is  %s, %s, %s and %s'  %(s_domain_data, t_domain_data, s_domain_generated_data, t_domain_generated_data))
      ...
      def train_iter():
            ...
            while True:
                if self.reshuffle:
                      os.popen('python shuffle.py ' + s_domain_data + ' ' + t_domain_data +' ' + s_domain_generated_data + ' '+ t_domain_generated_data)
                      os.popen('mv ' + s_domain_data + '.shuf '+ s_domain_data)
                      os.popen('mv ' + t_domain_data + '.shuf '+ t_domain_data)
                      os.popen('mv ' + s_domain_generated_data + '.shuf ' + s_domain_generated_data)
                      os.popen('mv ' + t_domain_generated_data + '.shuf ' + t_domain_generated_data)

             
                disTrain = unSuperGanTextIterator(s_domain_data, t_domain_data, s_domain_generated_data, t_domain_generated_data,
                                              self.dictionaries[0], self.dictionaries[1],
                                              batch = self.batch_size * self.gpu_num,
                                              maxlen = self.max_len,
                                              n_words_source = self.vocab_size_s,
                                              n_words_target = self.vocab_size_t)
      ...
      #print(self.gpu_num)
      #print(self.batch_size * self.gpu_num)
      drop_prob = 1.0
